...
opacity: 0.92;
background-image:  linear-gradient(135deg, #0498ad 25%, transparent 25%), linear-gradient(225deg, #0498ad 25%, transparent 25%), linear-gradient(45deg, #59bdca 25%, transparent 25%), linear-gradient(315deg, #0498ad 25%, #e5e5f7 25%);
